...
public class MusicDownAction extends AbstractInputAction{ 
	...
	public MusicDownAction(MyGame g, SceneNode d, IAudioManager a, ArrayList<Sound> s, int c)
	{
        myGame = g;
        dolphinN = d;
        audioMgr = a;
